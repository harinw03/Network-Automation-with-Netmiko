...
#Connect to device
        try:
                connection = netmiko.ConnectHandler(host=device, device_type='paloalto_panos', username=<username>, password=decode )

                output = (connection.send_command_timing('show config running'))
